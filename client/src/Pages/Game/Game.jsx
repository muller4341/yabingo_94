...
//   // Count patterns excluding 'nomarks' for numberofwinningpatterns 1-5
...
//   // For numberofwinningpatterns 2-5, check if the number of non-nomarks patterns meets or exceeds the requirement
//   if (numberOfWinningPatterns >= 2 && numberOfWinningPatterns <= 5) {
...
//           try: "/images/Audio/bingo/t.mp3", // Local path
//           notFound: "/images/Audio/bingo/n.mp3", // Local path
//           pass: "/images/Audio/bingo/pass.mp3", // Local path
//         }
//         console.log("Loading control audios first...")
//         const controlPromises = Object.entries(controlAudios).map(([key, path]) => {
//           return new Promise((resolve) => {
...
//     // Use numberofwinningpatterns from recent data, default to 1 if not available
