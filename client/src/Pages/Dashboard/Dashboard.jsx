  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center w-auto h-auto  items-center">
        <button className='w-16 h-12  sm:inline  dark:bg-gray-800 bg-white 
                    dark:hover:bg-gray-900 hover:bg-gray-100 rounded-lg border flex justify-items-center' onClick={()=>dispatch(toggleTheme())} >
      ...
      <div>
        {currentUser?(
                                     ...
                                     label={
                                        <div className=" flex w-[60px] h-[60px] border-1  rounded-full hover:scale-105 transition-transform duration-300 overflow-hidden justify-center items-center
      ...
      {/* <ul className="bg-white rounded p-2 max-h-24 overflow-y-auto">
        {filteredData.length > 0 ? (
          filteredData.map((item, index) => (
            <li key={index} className="text-fuchsia-900 font-semibold py-1">
              {item}
            </li>
          ))
        ) : (
          <li className="text-gray-500">No match found</li>
        )}
      </ul> */}
